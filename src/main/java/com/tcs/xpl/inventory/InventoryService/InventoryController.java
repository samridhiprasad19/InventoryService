...
public class InventoryController {
	...
	@Autowired
	public InventoryService cservice;
	
	@RequestMapping(value="/create", method = RequestMethod.POST)
	public ResponseEntity<String> createProduct(@RequestBody Inventory iv){
		return new ResponseEntity<String>(cservice.addProduct(iv), HttpStatus.OK);
	}
	...
	public ResponseEntity<Inventory> getProductById(@PathVariable("product_Id") int idd){
